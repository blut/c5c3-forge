...
//
// Visibility on persistent patch failure (review-2 suggestion 1):
...
func (r *KeystoneReconciler) recordDBJobTerminalState(ctx context.Context, keystone *keystonev1alpha1.Keystone, jobSuffix string) {
	...
	if err := r.Patch(ctx, patchTarget, patch); err != nil {
		// review-2 suggestion 1: log at Info (default level) and
...
// upgrade phases. All three phases run with the NEW release image:
