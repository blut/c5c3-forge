...
// +groupName=glance.openstack.c5c3.io
...
// Package v1alpha1 contains the Glance service and GlanceBackend API types.
package v1alpha1
...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "glance.openstack.c5c3.io", Version: "v1alpha1"}
