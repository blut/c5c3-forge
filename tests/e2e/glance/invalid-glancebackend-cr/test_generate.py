...
"""Fast unit tests for the invalid GlanceBackend fixture generator.
...
# (00-04), the glanceRef-immutability pair (05-base, 06-update), and the
# single-default pair (07-base, 08-second). Bumping this value requires adding
...
def _load_generator() -> types.ModuleType:
    spec = importlib.util.spec_from_file_location("glancebackend_invalid_cr_generate", _GENERATOR)
